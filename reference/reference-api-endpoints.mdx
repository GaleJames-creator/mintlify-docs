...
* [Using the hitCount field for analytics](/conceptual-guides/conceptual-guides-using-hitcount-for-analytics) - Learn how to leverage the new hitCount field for insights.
* [Code examples](/reference/reference-code-examples) - Explore example code snippets in various programming languages.

### How-to guides

* [Migrate from BookHub Publisher API v1 to v2](/how-to-guides/how-to-guides-migrate-bookhub) - Step-by-step migration instructions for updating your code to v2.
...
* [Data models](/reference/reference-data-models) - Detailed information about the data models used in the API, including the `hitCount` field.
