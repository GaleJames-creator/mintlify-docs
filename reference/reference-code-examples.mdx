...
* [API reference](/reference/reference-api) - Updated API reference documentation for BookHub Publisher API v2, including details on the `hitCount` field and its usage for tracking book performance.
* [Code examples](/reference/reference-code-examples) - Updated code examples demonstrating how to use the `hitCount` field effectively to analyze book performance trends over time.
