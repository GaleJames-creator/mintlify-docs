...
This section outlines the breaking changes introduced in version 2.0 of the BookHub Publisher API. If you are currently using version 1, please review these changes carefully to ensure a smooth migration to v2.
