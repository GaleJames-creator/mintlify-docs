...
```mdx your-page
import { sdkVersion, baseUrl } from '/snippets/vars';
...
```mdx your-page
import { EndpointNote } from '/snippets/endpoint-note';
...
```mdx snippets/auth-intro
import AuthNote from '/snippets/auth-note';
